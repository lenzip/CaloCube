//
// File generated by rootcint at Tue Sep  3 15:11:56 2013
...
namespace ROOT {
   namespace Shadow {
      ...
      class Crystal  {
         ...
         vector< pair< ::CaloCube::Ref< ::CaloCube::Particle >, double >  > _allOpticalOriginatingHere; //
      };
      #endif
      } 
      namespace CaloCube {
      ...
      #if !(defined(R__ACCESS_IN_SYMBOL) || defined(R__USE_SHADOW_CLASS))
      typedef ::CaloCube::Shower Shower;
      #else
      class Shower  {
         public:
         //friend XX;
         ...
         double _totalEnergy; //
         double _nCrystals; //
         vector< ::CaloCube::Ref< ::CaloCube::Crystal >  > _crystals; //
         vector< ::CaloCube::Ref< ::CaloCube::Crystal >  > _crystalsAbove; //
         double _nOptical; //
      };
      #endif
      } 
      ...
      #if !(defined(R__ACCESS_IN_SYMBOL) || defined(R__USE_SHADOW_CLASS))
      typedef ::CaloCube::Ref< ::CaloCube::Crystal > ReflECaloCubecLcLCrystalgR;
      #else
      class ReflECaloCubecLcLCrystalgR  {
         public:
         //friend XX;
         string _treeName; //
         string _branchName; //
...
namespace CaloCube {
   namespace ROOT {
      ...
      {
         static ::ROOT::TGenericClassInfo 
            instance("CaloCube", 0 /*version*/, "./../include/Shower.h", 8,
                     ::ROOT::DefineBehavior((void*)0,(void*)0),
...
namespace ROOT {
   void CaloCubecLcLShower_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void CaloCubecLcLShower_Dictionary();
   static void *new_CaloCubecLcLShower(void *p = 0);
   static void *newArray_CaloCubecLcLShower(Long_t size, void *p);
   static void delete_CaloCubecLcLShower(void *p);
   static void deleteArray_CaloCubecLcLShower(void *p);
   static void destruct_CaloCubecLcLShower(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CaloCube::Shower*)
   {
      // Make sure the shadow class has the right sizeof
      R__ASSERT(sizeof(::CaloCube::Shower) == sizeof(::ROOT::Shadow::CaloCube::Shower));
      ::CaloCube::Shower *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::CaloCube::Shower),0);
      static ::ROOT::TGenericClassInfo 
         instance("CaloCube::Shower", "./../include/Shower.h", 10,
                  typeid(::CaloCube::Shower), DefineBehavior(ptr, ptr),
                  &CaloCubecLcLShower_ShowMembers, &CaloCubecLcLShower_Dictionary, isa_proxy, 4,
                  sizeof(::CaloCube::Shower) );
      instance.SetNew(&new_CaloCubecLcLShower);
      instance.SetNewArray(&newArray_CaloCubecLcLShower);
      instance.SetDelete(&delete_CaloCubecLcLShower);
      instance.SetDeleteArray(&deleteArray_CaloCubecLcLShower);
      instance.SetDestructor(&destruct_CaloCubecLcLShower);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::CaloCube::Shower*)
   {
      return GenerateInitInstanceLocal((::CaloCube::Shower*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::CaloCube::Shower*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static void CaloCubecLcLShower_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const ::CaloCube::Shower*)0x0)->GetClass();
   }

} // end of namespace ROOT

namespace ROOT {
   void CaloCubecLcLReflECaloCubecLcLCrystalgR_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void CaloCubecLcLReflECaloCubecLcLCrystalgR_Dictionary();
   static void *new_CaloCubecLcLReflECaloCubecLcLCrystalgR(void *p = 0);
   static void *newArray_CaloCubecLcLReflECaloCubecLcLCrystalgR(Long_t size, void *p);
   static void delete_CaloCubecLcLReflECaloCubecLcLCrystalgR(void *p);
   static void deleteArray_CaloCubecLcLReflECaloCubecLcLCrystalgR(void *p);
   static void destruct_CaloCubecLcLReflECaloCubecLcLCrystalgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CaloCube::Ref<CaloCube::Crystal>*)
   {
      // Make sure the shadow class has the right sizeof
      R__ASSERT(sizeof(::CaloCube::Ref<CaloCube::Crystal>) == sizeof(::ROOT::Shadow::CaloCube::ReflECaloCubecLcLCrystalgR));
      ::CaloCube::Ref<CaloCube::Crystal> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::CaloCube::Ref<CaloCube::Crystal>),0);
      static ::ROOT::TGenericClassInfo 
         instance("CaloCube::Ref<CaloCube::Crystal>", "./../include/Ref.h", 13,
                  typeid(::CaloCube::Ref<CaloCube::Crystal>), DefineBehavior(ptr, ptr),
                  &CaloCubecLcLReflECaloCubecLcLCrystalgR_ShowMembers, &CaloCubecLcLReflECaloCubecLcLCrystalgR_Dictionary, isa_proxy, 4,
                  sizeof(::CaloCube::Ref<CaloCube::Crystal>) );
      instance.SetNew(&new_CaloCubecLcLReflECaloCubecLcLCrystalgR);
      instance.SetNewArray(&newArray_CaloCubecLcLReflECaloCubecLcLCrystalgR);
      instance.SetDelete(&delete_CaloCubecLcLReflECaloCubecLcLCrystalgR);
      instance.SetDeleteArray(&deleteArray_CaloCubecLcLReflECaloCubecLcLCrystalgR);
      instance.SetDestructor(&destruct_CaloCubecLcLReflECaloCubecLcLCrystalgR);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::CaloCube::Ref<CaloCube::Crystal>*)
   {
      return GenerateInitInstanceLocal((::CaloCube::Ref<CaloCube::Crystal>*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::CaloCube::Ref<CaloCube::Crystal>*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static void CaloCubecLcLReflECaloCubecLcLCrystalgR_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const ::CaloCube::Ref<CaloCube::Crystal>*)0x0)->GetClass();
   }
...
namespace ROOT {
   void CaloCubecLcLParticle_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      R__insp.InspectMember("G4ThreeVector", (void*)&sobj->_pos, "_pos.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_crystalPos", (void*)&sobj->_crystalPos);
      R__insp.InspectMember("CaloCube::Position", (void*)&sobj->_crystalPos, "_crystalPos.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*_track", &sobj->_track);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_collected", &sobj->_collected);
   }
...
namespace ROOT {
   void CaloCubecLcLCrystal_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_allOpticalOriginatingHere", (void*)&sobj->_allOpticalOriginatingHere);
      R__insp.InspectMember("vector<std::pair<CaloCube::Ref<CaloCube::Particle>,double> >", (void*)&sobj->_allOpticalOriginatingHere, "_allOpticalOriginatingHere.", false);
   }
...
namespace ROOT {
   void CaloCubecLcLShower_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      // Inspect the data members of an object of class CaloCube::Shower.
      typedef ::ROOT::Shadow::CaloCube::Shower ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      if (sobj) { } // Dummy usage just in case there is no datamember.

      TClass *R__cl  = ::ROOT::GenerateInitInstanceLocal((const ::CaloCube::Shower*)0x0)->GetClass();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_event", &sobj->_event);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_threshold", &sobj->_threshold);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_totalEnergy", &sobj->_totalEnergy);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_nCrystals", &sobj->_nCrystals);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_crystals", (void*)&sobj->_crystals);
      R__insp.InspectMember("vector<CaloCube::Ref<CaloCube::Crystal> >", (void*)&sobj->_crystals, "_crystals.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_crystalsAbove", (void*)&sobj->_crystalsAbove);
      R__insp.InspectMember("vector<CaloCube::Ref<CaloCube::Crystal> >", (void*)&sobj->_crystalsAbove, "_crystalsAbove.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_nOptical", &sobj->_nOptical);
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_CaloCubecLcLShower(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) ::CaloCube::Shower : new ::CaloCube::Shower;
   }
   static void *newArray_CaloCubecLcLShower(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) ::CaloCube::Shower[nElements] : new ::CaloCube::Shower[nElements];
   }
   // Wrapper around operator delete
   static void delete_CaloCubecLcLShower(void *p) {
      delete ((::CaloCube::Shower*)p);
   }
   static void deleteArray_CaloCubecLcLShower(void *p) {
      delete [] ((::CaloCube::Shower*)p);
   }
   static void destruct_CaloCubecLcLShower(void *p) {
      typedef ::CaloCube::Shower current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::CaloCube::Shower
...
namespace ROOT {
   void CaloCubecLcLReflECaloCubecLcLCrystalgR_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      // Inspect the data members of an object of class CaloCube::Ref<CaloCube::Crystal>.
      typedef ::ROOT::Shadow::CaloCube::ReflECaloCubecLcLCrystalgR ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      if (sobj) { } // Dummy usage just in case there is no datamember.

      TClass *R__cl  = ::ROOT::GenerateInitInstanceLocal((const ::CaloCube::Ref<CaloCube::Crystal>*)0x0)->GetClass();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_treeName", (void*)&sobj->_treeName);
      R__insp.InspectMember("string", (void*)&sobj->_treeName, "_treeName.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "_branchName", (void*)&sobj->_branchName);
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_CaloCubecLcLReflECaloCubecLcLCrystalgR(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) ::CaloCube::Ref<CaloCube::Crystal> : new ::CaloCube::Ref<CaloCube::Crystal>;
   }
   static void *newArray_CaloCubecLcLReflECaloCubecLcLCrystalgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) ::CaloCube::Ref<CaloCube::Crystal>[nElements] : new ::CaloCube::Ref<CaloCube::Crystal>[nElements];
   }
   // Wrapper around operator delete
   static void delete_CaloCubecLcLReflECaloCubecLcLCrystalgR(void *p) {
      delete ((::CaloCube::Ref<CaloCube::Crystal>*)p);
   }
   static void deleteArray_CaloCubecLcLReflECaloCubecLcLCrystalgR(void *p) {
      delete [] ((::CaloCube::Ref<CaloCube::Crystal>*)p);
   }
   static void destruct_CaloCubecLcLReflECaloCubecLcLCrystalgR(void *p) {
      typedef ::CaloCube::Ref<CaloCube::Crystal> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::CaloCube::Ref<CaloCube::Crystal>
...
namespace ROOT {
   void vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR_Dictionary();
   static void *new_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(void *p = 0);
   static void *newArray_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(Long_t size, void *p);
   static void delete_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(void *p);
   static void deleteArray_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(void *p);
   static void destruct_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<CaloCube::Ref<CaloCube::Crystal> >*)
   {
      vector<CaloCube::Ref<CaloCube::Crystal> > *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<CaloCube::Ref<CaloCube::Crystal> >),0);
      static ::ROOT::TGenericClassInfo 
         instance("vector<CaloCube::Ref<CaloCube::Crystal> >", -2, "/usr/local//lib/root/cint/cint/lib/prec_stl/vector", 49,
                  typeid(vector<CaloCube::Ref<CaloCube::Crystal> >), DefineBehavior(ptr, ptr),
                  0, &vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR_Dictionary, isa_proxy, 0,
                  sizeof(vector<CaloCube::Ref<CaloCube::Crystal> >) );
      instance.SetNew(&new_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR);
      instance.SetNewArray(&newArray_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR);
      instance.SetDelete(&delete_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR);
      instance.SetDeleteArray(&deleteArray_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR);
      instance.SetDestructor(&destruct_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<CaloCube::Ref<CaloCube::Crystal> > >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const vector<CaloCube::Ref<CaloCube::Crystal> >*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static void vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const vector<CaloCube::Ref<CaloCube::Crystal> >*)0x0)->GetClass();
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<CaloCube::Ref<CaloCube::Crystal> > : new vector<CaloCube::Ref<CaloCube::Crystal> >;
   }
   static void *newArray_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<CaloCube::Ref<CaloCube::Crystal> >[nElements] : new vector<CaloCube::Ref<CaloCube::Crystal> >[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(void *p) {
      delete ((vector<CaloCube::Ref<CaloCube::Crystal> >*)p);
   }
   static void deleteArray_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(void *p) {
      delete [] ((vector<CaloCube::Ref<CaloCube::Crystal> >*)p);
   }
   static void destruct_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgR(void *p) {
      typedef vector<CaloCube::Ref<CaloCube::Crystal> > current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<CaloCube::Ref<CaloCube::Crystal> >
...
, *((G4ThreeVector*) G__int(libp->para[4])), (int) G__int(libp->para[5])
...
{
      {
         const G4ThreeVector& obj = ((const CaloCube::Particle*) G__getstructoffset())->getPositionOfOrigin();
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
{
      {
         const CaloCube::Position& obj = ((const CaloCube::Particle*) G__getstructoffset())->getCrystalPosition();
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__CaloCubeDictionary_204_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
static int G__CaloCubeDictionary_557_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const vector<std::pair<CaloCube::Ref<CaloCube::Particle>,double> >* pobj;
         const vector<std::pair<CaloCube::Ref<CaloCube::Particle>,double> > xobj = ((const CaloCube::Crystal*) G__getstructoffset())->getAllOpticalOriginatingHere();
         pobj = new vector<std::pair<CaloCube::Ref<CaloCube::Particle>,double> >(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
{
      ((CaloCube::Crystal*) G__getstructoffset())->addOpticalOriginatingHere(*(CaloCube::Ref<CaloCube::Particle>*) libp->para[0].ref, (double) G__double(libp->para[1]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__CaloCubeDictionary_557_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__CaloCubeDictionary_557_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* CaloCube::Shower */
static int G__CaloCubeDictionary_568_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   CaloCube::Shower* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
   if (n) {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new CaloCube::Shower[n];
     } else {
       p = new((void*) gvp) CaloCube::Shower[n];
     }
   } else {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new CaloCube::Shower;
     } else {
       p = new((void*) gvp) CaloCube::Shower;
     }
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLShower));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CaloCubeDictionary_568_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   CaloCube::Shower* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 3
...
, *(vector<CaloCube::Crystal>*) libp->para[2].ref);
   } else {
     p = new((void*) gvp) CaloCube::Shower(
(unsigned int) G__int(libp->para[0]), (double) G__double(libp->para[1])
, *(vector<CaloCube::Crystal>*) libp->para[2].ref);
...
static int G__CaloCubeDictionary_568_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const CaloCube::Shower*) G__getstructoffset())->getEventNumber());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CaloCubeDictionary_568_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const CaloCube::Shower*) G__getstructoffset())->getNCrystalsAboveThreshold());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CaloCubeDictionary_568_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const CaloCube::Shower*) G__getstructoffset())->getTotalEnergy());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CaloCubeDictionary_568_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const vector<CaloCube::Ref<CaloCube::Crystal> >& obj = ((const CaloCube::Shower*) G__getstructoffset())->getAllCrystals();
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__CaloCubeDictionary_568_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const vector<CaloCube::Ref<CaloCube::Crystal> >& obj = ((const CaloCube::Shower*) G__getstructoffset())->getCrystalsAboveThreshold();
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__CaloCubeDictionary_568_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const CaloCube::Shower*) G__getstructoffset())->getNOptical());
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__CaloCubeDictionary_568_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)

{
   CaloCube::Shower* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new CaloCube::Shower(*(CaloCube::Shower*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLShower));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef CaloCube::Shower G__TCaloCubecLcLShower;
static int G__CaloCubeDictionary_568_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (CaloCube::Shower*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((CaloCube::Shower*) (soff+(sizeof(CaloCube::Shower)*i)))->~G__TCaloCubecLcLShower();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((CaloCube::Shower*) (soff))->~G__TCaloCubecLcLShower();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
// automatic assignment operator
static int G__CaloCubeDictionary_568_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   CaloCube::Shower* dest = (CaloCube::Shower*) G__getstructoffset();
   *dest = *(CaloCube::Shower*) libp->para[0].ref;
   const CaloCube::Shower& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__CaloCubeDictionary_570_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator* pobj;
...
static int G__CaloCubeDictionary_570_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::reverse_iterator* pobj;
...
static int G__CaloCubeDictionary_570_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >*) G__getstructoffset())->size());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CaloCubeDictionary_570_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >*) G__getstructoffset())->max_size());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CaloCubeDictionary_570_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >*) G__getstructoffset())->capacity());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CaloCubeDictionary_570_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((const vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >*) G__getstructoffset())->empty());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CaloCubeDictionary_570_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G__CaloCubeDictionary_570_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__CaloCubeDictionary_570_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 2
...
static int G__CaloCubeDictionary_570_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_570_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator* pobj;
...
static int G__CaloCubeDictionary_570_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_570_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
/* CaloCube::Ref<CaloCube::Crystal> */
static int G__CaloCubeDictionary_573_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   CaloCube::Ref<CaloCube::Crystal>* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
   if (n) {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new CaloCube::Ref<CaloCube::Crystal>[n];
     } else {
       p = new((void*) gvp) CaloCube::Ref<CaloCube::Crystal>[n];
     }
   } else {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new CaloCube::Ref<CaloCube::Crystal>;
     } else {
       p = new((void*) gvp) CaloCube::Ref<CaloCube::Crystal>;
     }
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR));
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      {
         const CaloCube::Crystal& obj = ((const CaloCube::Ref<CaloCube::Crystal>*) G__getstructoffset())->get();
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
{
   CaloCube::Ref<CaloCube::Crystal>* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new CaloCube::Ref<CaloCube::Crystal>(*(CaloCube::Ref<CaloCube::Crystal>*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef CaloCube::Ref<CaloCube::Crystal> G__TCaloCubecLcLReflECaloCubecLcLCrystalgR;
static int G__CaloCubeDictionary_573_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (CaloCube::Ref<CaloCube::Crystal>*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((CaloCube::Ref<CaloCube::Crystal>*) (soff+(sizeof(CaloCube::Ref<CaloCube::Crystal>)*i)))->~G__TCaloCubecLcLReflECaloCubecLcLCrystalgR();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((CaloCube::Ref<CaloCube::Crystal>*) (soff))->~G__TCaloCubecLcLReflECaloCubecLcLCrystalgR();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
{
   CaloCube::Ref<CaloCube::Crystal>* dest = (CaloCube::Ref<CaloCube::Crystal>*) G__getstructoffset();
   *dest = *(CaloCube::Ref<CaloCube::Crystal>*) libp->para[0].ref;
   const CaloCube::Ref<CaloCube::Crystal>& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__CaloCubeDictionary_579_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator* pobj;
...
static int G__CaloCubeDictionary_579_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::reverse_iterator* pobj;
...
static int G__CaloCubeDictionary_579_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G__CaloCubeDictionary_579_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__CaloCubeDictionary_579_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 2
...
static int G__CaloCubeDictionary_579_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CaloCubeDictionary_579_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator* pobj;
...
static int G__CaloCubeDictionary_579_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CaloCubeDictionary_579_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
extern "C" void G__cpp_setup_typetableCaloCubeDictionary() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<CaloCube::Ref<CaloCube::Crystal> >",117,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memvarCaloCubecLcLParticle(void) {
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CLHEPcLcLHep3Vector),G__defined_typename("G4ThreeVector"),-1,4,"_pos=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLPosition),-1,-1,4,"_crystalPos=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,1,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_G4Track),-1,-1,4,"_track=",0,"! transient value");
   G__memvar_setup((void*)0,103,0,0,-1,-1,-1,4,"_collected=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memvarCaloCubecLcLCrystal(void) {
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlEpairlECaloCubecLcLReflECaloCubecLcLParticlegRcOdoublegRcOallocatorlEpairlECaloCubecLcLReflECaloCubecLcLParticlegRcOdoublegRsPgRsPgR),G__defined_typename("vector<std::pair<CaloCube::Ref<CaloCube::Particle>,double> >"),-1,4,"_allOpticalOriginatingHere=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memvarvectorlEpairlECaloCubecLcLReflECaloCubecLcLParticlegRcOdoublegRcOallocatorlEpairlECaloCubecLcLReflECaloCubecLcLParticlegRcOdoublegRsPgRsPgR(void) {
   ...
   /* CaloCube::Shower */
static void G__setup_memvarCaloCubecLcLShower(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLShower));
   { CaloCube::Shower *p; p=(CaloCube::Shower*)0x1000; if (p) { }
   G__memvar_setup((void*)0,104,0,0,-1,-1,-1,4,"_event=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"_threshold=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"_totalEnergy=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"_nCrystals=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR),G__defined_typename("vector<CaloCube::Ref<CaloCube::Crystal> >"),-1,4,"_crystals=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR),G__defined_typename("vector<CaloCube::Ref<CaloCube::Crystal> >"),-1,4,"_crystalsAbove=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"_nOptical=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memvarvectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgR(void) {
   ...
   /* CaloCube::Ref<CaloCube::Crystal> */
static void G__setup_memvarCaloCubecLcLReflECaloCubecLcLCrystalgR(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR));
   { CaloCube::Ref<CaloCube::Crystal> *p; p=(CaloCube::Ref<CaloCube::Crystal>*)0x1000; if (p) { }
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_string),-1,-1,4,"_treeName=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_string),-1,-1,4,"_branchName=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-2,4,"_lastevent=",0,(char*)NULL);
   G__memvar_setup((void*)0,104,0,0,-1,-1,-1,4,"_index=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgR),G__defined_typename("vector<CaloCube::Crystal>"),-2,4,"_container=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncCaloCubecLcLParticle(void) {
   ...
   G__memfunc_setup("Particle",820,G__CaloCubeDictionary_204_0_2, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLParticle), -1, 0, 8, 1, 1, 0, 
"u 'string' - 0 - name u 'string' - 0 - creatorProcess "
"d - - 0 - energy u 'CLHEP::Hep3Vector' 'G4ThreeVector' 0 - momentum "
"u 'CLHEP::Hep3Vector' 'G4ThreeVector' 0 - pos i - - 0 - x "
"i - - 0 - y i - - 0 - z", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("getPositionOfOrigin",1970,G__CaloCubeDictionary_204_0_8, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CLHEPcLcLHep3Vector), G__defined_typename("G4ThreeVector"), 1, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getCrystalPosition",1911,G__CaloCubeDictionary_204_0_9, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLPosition), -1, 1, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setTrack",833,G__CaloCubeDictionary_204_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "U 'G4Track' - 10 - track", "! transient", (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("Particle", 820, G__CaloCubeDictionary_204_0_11, (int) ('i'), G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLParticle), -1, 0, 1, 1, 1, 0, "u 'CaloCube::Particle' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Particle", 946, G__CaloCubeDictionary_204_0_12, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
"i - - 0 - z u 'string' - 0 - material", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("getAllOpticalOriginatingHere",2852,G__CaloCubeDictionary_557_0_9, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlEpairlECaloCubecLcLReflECaloCubecLcLParticlegRcOdoublegRcOallocatorlEpairlECaloCubecLcLReflECaloCubecLcLParticlegRcOdoublegRsPgRsPgR), G__defined_typename("vector<std::pair<CaloCube::Ref<CaloCube::Particle>,double> >"), 0, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("addParticlePassingHere",2230,G__CaloCubeDictionary_557_0_10, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'CaloCube::Ref<CaloCube::Particle>' - 11 - ref d - - 0 - energyDeposit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("addParticleOriginatingHere",2652,G__CaloCubeDictionary_557_0_11, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'CaloCube::Ref<CaloCube::Particle>' - 11 - ref d - - 0 - energyDeposit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("addPi0OriginatingHere",2065,G__CaloCubeDictionary_557_0_12, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'CaloCube::Ref<CaloCube::Particle>' - 11 - ref d - - 0 - energyDeposit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("addOpticalOriginatingHere",2548,G__CaloCubeDictionary_557_0_13, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'CaloCube::Ref<CaloCube::Particle>' - 11 - ref d - - 0 - energyDeposit", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("Crystal", 738, G__CaloCubeDictionary_557_0_14, (int) ('i'), G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), -1, 0, 1, 1, 1, 0, "u 'CaloCube::Crystal' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Crystal", 864, G__CaloCubeDictionary_557_0_15, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__CaloCubeDictionary_557_0_16, (int) ('u'), G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), -1, 1, 1, 1, 1, 0, "u 'CaloCube::Crystal' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncCaloCubecLcLShower(void) {
   /* CaloCube::Shower */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLShower));
   G__memfunc_setup("Shower",632,G__CaloCubeDictionary_568_0_1, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLShower), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Shower",632,G__CaloCubeDictionary_568_0_2, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLShower), -1, 0, 3, 1, 1, 0, 
"h - - 0 - iEvent d - - 0 - threshold "
"u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >' 'vector<CaloCube::Crystal>' 11 - crystals", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getEventNumber",1451,G__CaloCubeDictionary_568_0_3, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getNCrystalsAboveThreshold",2685,G__CaloCubeDictionary_568_0_4, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getTotalEnergy",1454,G__CaloCubeDictionary_568_0_5, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getAllCrystals",1454,G__CaloCubeDictionary_568_0_6, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR), G__defined_typename("vector<CaloCube::Ref<CaloCube::Crystal> >"), 1, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getCrystalsAboveThreshold",2607,G__CaloCubeDictionary_568_0_7, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR), G__defined_typename("vector<CaloCube::Ref<CaloCube::Crystal> >"), 1, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getNOptical",1114,G__CaloCubeDictionary_568_0_8, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("Shower", 632, G__CaloCubeDictionary_568_0_9, (int) ('i'), G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLShower), -1, 0, 1, 1, 1, 0, "u 'CaloCube::Shower' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Shower", 758, G__CaloCubeDictionary_568_0_10, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__CaloCubeDictionary_568_0_11, (int) ('u'), G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLShower), -1, 1, 1, 1, 1, 0, "u 'CaloCube::Shower' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgR(void) {
   ...
   G__memfunc_setup("at",213,G__CaloCubeDictionary_570_0_1, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__CaloCubeDictionary_570_0_2, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__CaloCubeDictionary_570_0_3, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__CaloCubeDictionary_570_0_4, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__CaloCubeDictionary_570_0_5, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgRcLcLiteratorgR), G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__CaloCubeDictionary_570_0_6, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgRcLcLiteratorgR), G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__CaloCubeDictionary_570_0_7, 107, -1, G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__CaloCubeDictionary_570_0_8, 107, -1, G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__CaloCubeDictionary_570_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__CaloCubeDictionary_570_0_10, 121, -1, -1, 0, 2, 1, 1, 0, 
"k - 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type' 0 - sz u 'CaloCube::Crystal' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__CaloCubeDictionary_570_0_11, 107, -1, G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__CaloCubeDictionary_570_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__CaloCubeDictionary_570_0_13, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__CaloCubeDictionary_570_0_14, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), G__defined_typename("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >",5180,G__CaloCubeDictionary_570_0_15, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >",5180,G__CaloCubeDictionary_570_0_16, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type' 0 - n u 'CaloCube::Crystal' - 11 'CaloCube::Crystal()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >",5180,G__CaloCubeDictionary_570_0_17, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >",5180,G__CaloCubeDictionary_570_0_18, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator' 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::const_iterator' 10 - first u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator' 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__CaloCubeDictionary_570_0_19, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__CaloCubeDictionary_570_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__CaloCubeDictionary_570_0_21, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__CaloCubeDictionary_570_0_22, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__CaloCubeDictionary_570_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'CaloCube::Crystal' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__CaloCubeDictionary_570_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__CaloCubeDictionary_570_0_25, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLCrystalcOallocatorlECaloCubecLcLCrystalgRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
"u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator' - 0 - position u 'CaloCube::Crystal' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__CaloCubeDictionary_570_0_26, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator' 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__CaloCubeDictionary_570_0_27, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'CaloCube::Crystal' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pop_back",831,G__CaloCubeDictionary_570_0_28, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__CaloCubeDictionary_570_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__CaloCubeDictionary_570_0_30, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator' - 0 - first u 'vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("clear",519,G__CaloCubeDictionary_570_0_31, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~vector<CaloCube::Crystal,allocator<CaloCube::Crystal> >", 5306, G__CaloCubeDictionary_570_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}

static void G__setup_memfuncCaloCubecLcLReflECaloCubecLcLCrystalgR(void) {
   /* CaloCube::Ref<CaloCube::Crystal> */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR));
   G__memfunc_setup("Ref<CaloCube::Crystal>",2027,G__CaloCubeDictionary_573_0_1, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Ref<CaloCube::Crystal>",2027,G__CaloCubeDictionary_573_0_2, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR), -1, 0, 3, 1, 1, 0, 
"u 'string' - 0 - treeName u 'string' - 0 - branchName "
"h - - 0 - index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("get",320,G__CaloCubeDictionary_573_0_3, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLCrystal), -1, 1, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("Ref<CaloCube::Crystal>", 2027, G__CaloCubeDictionary_573_0_4, (int) ('i'), 
G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR), -1, 0, 1, 1, 1, 0, "u 'CaloCube::Ref<CaloCube::Crystal>' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Ref<CaloCube::Crystal>", 2153, G__CaloCubeDictionary_573_0_5, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__CaloCubeDictionary_573_0_6, (int) ('u'), G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR), -1, 1, 1, 1, 1, 0, "u 'CaloCube::Ref<CaloCube::Crystal>' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgR(void) {
   ...
   G__memfunc_setup("at",213,G__CaloCubeDictionary_579_0_1, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLParticlegR), G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::reference"), 1, 1, 1, 1, 0, "k - 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__CaloCubeDictionary_579_0_2, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLParticlegR), G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__CaloCubeDictionary_579_0_3, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__CaloCubeDictionary_579_0_4, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__CaloCubeDictionary_579_0_5, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgRcLcLiteratorgR), G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__CaloCubeDictionary_579_0_6, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgRcLcLiteratorgR), G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__CaloCubeDictionary_579_0_7, 107, -1, G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__CaloCubeDictionary_579_0_8, 107, -1, G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__CaloCubeDictionary_579_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__CaloCubeDictionary_579_0_10, 121, -1, -1, 0, 2, 1, 1, 0, 
"k - 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type' 0 - sz u 'CaloCube::Ref<CaloCube::Particle>' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__CaloCubeDictionary_579_0_11, 107, -1, G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__CaloCubeDictionary_579_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__CaloCubeDictionary_579_0_13, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLParticlegR), G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::reference"), 1, 1, 1, 1, 0, "k - 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__CaloCubeDictionary_579_0_14, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLParticlegR), G__defined_typename("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >",7954,G__CaloCubeDictionary_579_0_15, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >",7954,G__CaloCubeDictionary_579_0_16, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type' 0 - n u 'CaloCube::Ref<CaloCube::Particle>' - 11 '(CaloCube::Ref<CaloCube::Particle>)()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >",7954,G__CaloCubeDictionary_579_0_17, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >",7954,G__CaloCubeDictionary_579_0_18, 105, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator' 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::const_iterator' 10 - first u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator' 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__CaloCubeDictionary_579_0_19, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__CaloCubeDictionary_579_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__CaloCubeDictionary_579_0_21, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLParticlegR), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__CaloCubeDictionary_579_0_22, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLParticlegR), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__CaloCubeDictionary_579_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'CaloCube::Ref<CaloCube::Particle>' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__CaloCubeDictionary_579_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__CaloCubeDictionary_579_0_25, 117, G__get_linked_tagnum(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLParticlegRcOallocatorlECaloCubecLcLReflECaloCubecLcLParticlegRsPgRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
"u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator' - 0 - position u 'CaloCube::Ref<CaloCube::Particle>' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__CaloCubeDictionary_579_0_26, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator' 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__CaloCubeDictionary_579_0_27, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'CaloCube::Ref<CaloCube::Particle>' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pop_back",831,G__CaloCubeDictionary_579_0_28, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__CaloCubeDictionary_579_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__CaloCubeDictionary_579_0_30, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator' - 0 - first u 'vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("clear",519,G__CaloCubeDictionary_579_0_31, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~vector<CaloCube::Ref<CaloCube::Particle>,allocator<CaloCube::Ref<CaloCube::Particle> > >", 8080, G__CaloCubeDictionary_579_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__CaloCubeDictionaryLN_CaloCubecLcLShower = { "CaloCube::Shower" , 99 , -1 };
...
G__linked_taginfo G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR = { "CaloCube::Ref<CaloCube::Crystal>" , 99 , -1 };
G__linked_taginfo G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR = { "vector<CaloCube::Ref<CaloCube::Crystal>,allocator<CaloCube::Ref<CaloCube::Crystal> > >" , 99 , -1 };
G__linked_taginfo G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<CaloCube::Ref<CaloCube::Crystal>,allocator<CaloCube::Ref<CaloCube::Crystal> > >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableCaloCubeDictionary() {
  ...
  G__CaloCubeDictionaryLN_CaloCubecLcLShower.tagnum = -1 ;
  ...
  G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR.tagnum = -1 ;
  G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR.tagnum = -1 ;
  G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableCaloCubeDictionary() {
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__CaloCubeDictionaryLN_CaloCubecLcLShower),sizeof(CaloCube::Shower),-1,295168,(char*)NULL,G__setup_memvarCaloCubecLcLShower,G__setup_memfuncCaloCubecLcLShower);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__CaloCubeDictionaryLN_CaloCubecLcLReflECaloCubecLcLCrystalgR),sizeof(CaloCube::Ref<CaloCube::Crystal>),-1,295168,(char*)NULL,G__setup_memvarCaloCubecLcLReflECaloCubecLcLCrystalgR,G__setup_memfuncCaloCubecLcLReflECaloCubecLcLCrystalgR);
   G__get_linked_tagnum_fwd(&G__CaloCubeDictionaryLN_vectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgR);
   G__get_linked_tagnum_fwd(&G__CaloCubeDictionaryLN_reverse_iteratorlEvectorlECaloCubecLcLReflECaloCubecLcLCrystalgRcOallocatorlECaloCubecLcLReflECaloCubecLcLCrystalgRsPgRsPgRcLcLiteratorgR);
